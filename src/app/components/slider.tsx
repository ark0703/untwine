    ...
    <div>
      <div className="grid  gap-4 w-full grid-cols-1 md:grid-cols-3 md:py-10">
        {imageData.map((item, index) => (
          <div
            key={index}
            className=" bg-[#FEFBEA] shadow-lg p-4 rounded-box flex flex-col items-center gap-2 justify-start text-center w-full"
          >
            <svg
              width="48"
              height="50"
